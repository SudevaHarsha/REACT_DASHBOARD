                       ...
                       return(
                        <ListItem key={text} disablePadding>
                            <ListItemButton onClick={() =>{
                                ...
                                sx={{
                                    backgroundColor: active === IcText ? theme.palette.secondary[300] : "transparent",
                                    color: active === IcText ? theme.palette.primary[600] : theme.palette.secondary[100], 
                                }}
                                >
                                    <ListItemIcon 
                                        sx={{
                                            ml:"2rem",
                                            color: active === IcText ? theme.palette.primary[600] : theme.palette.secondary[200],
                                        }}>
                                        {icon}
                                    </ListItemIcon>
